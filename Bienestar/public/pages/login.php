        ...
        <div class="auth-box">
            ...
            <form id="loginForm" action="../../controllers/login.php" method="POST" class="auth-form">
                ...
                <div class="form-options">
                    ...
                    <a href="recuperacion.php" class="link-secondary">¿Olvidaste tu contraseña?</a>
                </div>
            ...
            <!-- Login con Google -->
            <a href="../../controllers/google_login.php" class="btn btn-google btn-block">
            ...
            <div class="auth-footer">
                <p>¿No tienes cuenta? <a href="register.php" class="link-primary">Regístrate aquí</a></p>
            </div>

            <!-- Link a home -->
            <div class="back-home">
                <a href="../index.php" class="link-secondary">← Volver al inicio</a>
            </div>
        </div>
